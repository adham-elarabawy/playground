...
# tune:
num_discrete_chunks = 20
LEARNING_RATE = 0.1
# a measure of how much we value future reqrd over current reward [0,1]
DISCOUNT = 0.95
EPISODES = 2000
SHOW_EVERY = 500

DISCRETE_OS_SIZE = [num_discrete_chunks] * len(env.observation_space.high)
